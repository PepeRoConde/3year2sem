...
# SARSA e Expected SARSA, sen perturbacion
...
python main.py --algoritmos s,sp --num_episodios $NUM_EPISODIOS --verboso $VERBOSO \
  --discretizacion_estado $DISCRETIZACION_ESTADO --discretizacion_accion $DISCRETIZACION_ACCION \
  --gamma $GAMMA --alpha 0.2 --alpha_min 0.0005 --alpha_decae \
  --epsilon 0.2 --epsilon_min 0.0005 --epsilon_decae \
  --inicializacion_informada --cartafol_figuras $CARTAFOL >> resultados.txt 

# Q-Learning, sen perturbacion
python main.py --algoritmos q --num_episodios $NUM_EPISODIOS --verboso $VERBOSO \
  --discretizacion_estado $DISCRETIZACION_ESTADO --discretizacion_accion $DISCRETIZACION_ACCION \
  --gamma $GAMMA --alpha 0.6 --alpha_min 0.0005 --alpha_decae \
  --epsilon 0.5 --epsilon_min 0.0005 --epsilon_decae \
  --inicializacion_informada --cartafol_figuras $CARTAFOL >> resultados.txt 
