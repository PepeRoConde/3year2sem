...
def main():
    ...
    robobo.setActiveBlobs(True, True, False, False)  # Activar detección de color verde
    ...
    find_color = FindColor(robobo, [], params, BlobColor.GREEN)
    push_color = PushColor(robobo, [find_color], params, BlobColor.GREEN)
